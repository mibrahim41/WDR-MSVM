num_exp = 50;
Lacc_tensor_multi = zeros([7,10,num_exp]);
Lacc_tensor_multi_s = zeros([7,10,num_exp]);
Lacc_tensor_multi_ker = zeros([7,10,num_exp]);
Lacc_tensor_multi_ker_s = zeros([7,10,num_exp]);

Lacc_tensor_ova = zeros([7,10,num_exp]);
Lacc_tensor_ova_s = zeros([7,10,num_exp]);
Lacc_tensor_ova_ker = zeros([7,10,num_exp]);
Lacc_tensor_ova_ker_s = zeros([7,10,num_exp]);

Lacc_tensor_Rmulti = zeros([7,num_exp]);
Lacc_tensor_Rmulti_s = zeros([7,num_exp]);
Lacc_tensor_Rmulti_ker = zeros([7,num_exp]);
Lacc_tensor_Rmulti_ker_s = zeros([7,num_exp]);

for i = 1:num_exp
    filename = sprintf('WDR_MSVM_pump_7_%d.mat',i);
    load(filename)
    Lacc_tensor_multi(:,:,i) = acc_tensor_multi(:,:,1);
    Lacc_tensor_multi_s(:,:,i) = acc_tensor_multi(:,:,2);
    Lacc_tensor_multi_ker(:,:,i) = acc_tensor_multi_ker_rbf(:,:,1);
    Lacc_tensor_multi_ker_s(:,:,i) = acc_tensor_multi_ker_rbf(:,:,2);
    
    Lacc_tensor_ova(:,:,i) = acc_tensor_ova(:,:,1);
    Lacc_tensor_ova_s(:,:,i) = acc_tensor_ova(:,:,2);
    Lacc_tensor_ova_ker(:,:,i) = acc_tensor_ova_ker_rbf(:,:,1);
    Lacc_tensor_ova_ker_s(:,:,i) = acc_tensor_ova_ker_rbf(:,:,2);
    
    Lacc_tensor_Rmulti(:,i) = acc_tensor_Rmulti2(:,1);
    Lacc_tensor_Rmulti_s(:,i) = acc_tensor_Rmulti2(:,2);
    Lacc_tensor_Rmulti_ker(:,i) = acc_tensor_Rmulti2_ker_rbf(:,1);
    Lacc_tensor_Rmulti_ker_s(:,i) = acc_tensor_Rmulti2_ker_rbf(:,2);
end

[acc_multi,std_multi] = comp_metrics(Lacc_tensor_multi);
[acc_multi_s,std_multi_s] = comp_metrics(Lacc_tensor_multi_s);

[acc_multi_ker,std_multi_ker] = comp_metrics(Lacc_tensor_multi_ker);
[acc_multi_ker_s,std_multi_ker_s] = comp_metrics(Lacc_tensor_multi_ker_s);

[acc_ova,std_ova] = comp_metrics(Lacc_tensor_ova);
[acc_ova_s,std_ova_s] = comp_metrics(Lacc_tensor_ova_s);

[acc_ova_ker,std_ova_ker] = comp_metrics(Lacc_tensor_ova_ker);
[acc_ova_ker_s,std_ova_ker_s] = comp_metrics(Lacc_tensor_ova_ker_s);

[acc_Rmulti,std_Rmulti] = comp_metrics2(Lacc_tensor_Rmulti);
[acc_Rmulti_s,std_Rmulti_s] = comp_metrics2(Lacc_tensor_Rmulti_s);

[acc_Rmulti_ker,std_Rmulti_ker] = comp_metrics2(Lacc_tensor_Rmulti_ker);
[acc_Rmulti_ker_s,std_Rmulti_ker_s] = comp_metrics2(Lacc_tensor_Rmulti_ker_s);
